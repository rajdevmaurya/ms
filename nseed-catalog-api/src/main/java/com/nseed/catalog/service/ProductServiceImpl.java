...
import com.nseed.catalog.repository.ProductRepository;
...
import com.nseed.catalog.mapper.ProductMapper;
	...
	public List<ProductRequestSummary> getProductRequestSummaryData(String q, Integer pageNo, Integer pageSize) {
		  ...
		  List<Product> pDataList=products.getContent();
		    ...
		    for (Product p : pDataList) {
		    	 ProductRequestSummary psr = ProductMapper.INSTANCE.productToProductRequestSummary(p);
